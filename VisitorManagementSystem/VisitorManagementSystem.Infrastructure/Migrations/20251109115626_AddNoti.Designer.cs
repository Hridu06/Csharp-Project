...
namespace VisitorManagementSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251109115626_AddNoti")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VisitorManagementSystem.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VisitRequest", b =>
                {
                    b.HasOne("VisitorManagementSystem.Domain.Entities.Employee", "Employee")
                        .WithMany("VisitRequests")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("VisitorManagementSystem.Domain.Entities.User", "Visitor")
                        .WithMany()
            ...
            modelBuilder.Entity("VisitorManagementSystem.Domain.Entities.Notification", b =>
                {
                    b.HasOne("VisitorManagementSystem.Domain.Entities.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("VisitorManagementSystem.Domain.Entities.User", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("VisitRequest", "VisitRequest")
                        .WithMany()
